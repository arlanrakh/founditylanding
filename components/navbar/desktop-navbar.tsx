...
import Link from "next/link"; // Use next/link instead of next-view-transitions for navigation
  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-2 items-center">
        <Button as={Link} href="https://forms.gle/mGoQzwXMxqJvX8pC8" target="_blank">
          Join Waitlist
        </Button>
      </div>
    </div>
